...
#Region "*************************window_new_project*********************************"

    ''' <summary>
    ''' window_new_project是否确定了要创建工程
    ''' </summary>
    Public window_new_project_ok_for_create As Boolean = False

    ''' <summary>
    ''' window_new_project工程名
    ''' </summary>
    Public window_new_project_project_name As String = ""
    ''' <summary>
    ''' window_new_project工程存储路径
    ''' </summary>
    Public window_new_project_project_path As String = ""
    ''' <summary>
    ''' window_new_project是否使用已有文件创建工程
    ''' </summary>
    Public window_new_project_use_old_file As Boolean = False
    ''' <summary>
    ''' window_new_project已有bus.txt路径
    ''' </summary>
    Public window_new_project_bus_path As String = ""
    ''' <summary>
    ''' window_new_project已有have_bus.txt路径
    ''' </summary>
    Public window_new_project_have_bus_path As String = ""

    ''' <summary>
    ''' 清空还原函数
    ''' </summary>
    Public Sub window_new_project_clear()

        window_new_project_ok_for_create = False

        window_new_project_project_name = ""
        window_new_project_project_path = ""
        window_new_project_use_old_file = False
        window_new_project_bus_path = ""
        window_new_project_have_bus_path = ""
